/***
 * Test für das 1,80 Zoll SPI TFT-Display
 * v1.0 - 2018-01-07
...
#define TFT_PIN_CS   10 // Arduino-Pin 
#define TFT_PIN_DC   9  // Arduino-Pin  
...
void setup(void) {
   ...
   * Muss bei AZ-Delivery 1.8'' 160x128px RGB TFT INITR_BLACKTAB sein ansonsten Pixelfehler rechts und unten.
